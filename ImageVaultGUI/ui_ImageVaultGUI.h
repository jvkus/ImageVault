/********************************************************************************
** Form generated from reading UI file 'ImageVaultGUIvrNBFM.ui'
**
...
#ifndef IMAGEVAULTGUIVRNBFM_H
#define IMAGEVAULTGUIVRNBFM_H
...
public:
	...
	void setupUi(QMainWindow *ImageVaultGUIClass)
	{
		...
		enterTextButton = new QPushButton(centralWidget);
		...
		verticalLayout_3->addWidget(enterTextButton);
		...
		QObject::connect(enterTextButton, SIGNAL(clicked()), enterTextButton, SLOT(showMenu()));
		...
		QObject::connect(EncryptRadio, SIGNAL(toggled(bool)), enterTextButton, SLOT(update()));
		QObject::connect(DecryptRadio, SIGNAL(toggled(bool)), enterTextButton, SLOT(update()));
	...
	void retranslateUi(QMainWindow *ImageVaultGUIClass)
	{
		...
		DecryptEncryptButton->setText(QCoreApplication::translate("ImageVaultGUIClass", "Select Mode", nullptr));
